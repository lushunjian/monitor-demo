...
public class Test {
    ...
    private static void process() throws SigarException{
        long[] pidList = sigar.getProcList();
        System.out.println("进程信息：");
//        long portPID = sigar.getProcPort(NetFlags.CONN_TCP, 3306);
  //      System.out.println("-------java进程号----"+portPID);
      /*  long myPid = sigar.getServicePid("MySQL56");
        System.out.println("-------MySQL56-pid-"+myPid);*/
        System.out.println();
        for(long pid : pidList){
            MyProcess process = new MyProcess(sigar,pid);
            System.out.println(process.toString());
        }
    }

    private static void processTest() throws SigarException, InterruptedException {
        System.out.println("进程信息：");
        long portPID = sigar.getProcPort(NetFlags.CONN_TCP, 3306);
        ProcCpu pCpu  = sigar.getProcCpu(portPID);
